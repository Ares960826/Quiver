...
直接打开[当前 Community Preview Release](https://github.com/Ares960826/Quiver/releases/tag/v0.1.0-preview.1)查看说明，或按 Mac 类型直接下载：

| Mac | 直接下载 |
|---|---|
| Apple Silicon（M1–M4） | [下载 `Quiver_0.1.0_aarch64.dmg`](https://github.com/Ares960826/Quiver/releases/download/v0.1.0-preview.1/Quiver_0.1.0_aarch64.dmg) |
| Intel | [下载 `Quiver_0.1.0_x64.dmg`](https://github.com/Ares960826/Quiver/releases/download/v0.1.0-preview.1/Quiver_0.1.0_x64.dmg) |

1. 在上表中选择与你的 Mac 匹配的版本。
2. 使用 [`SHA256SUMS.txt`](https://github.com/Ares960826/Quiver/releases/download/v0.1.0-preview.1/SHA256SUMS.txt)核验文件，然后把 Quiver 拖入“应用程序”。
